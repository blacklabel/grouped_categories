...
import CSSObject from 'highcharts-github/ts/Core/Renderer/CSSObject';
...
// Type definitions for grouped categories
...
// Custom interface that doesn't extend XAxisOptions to avoid conflicts
